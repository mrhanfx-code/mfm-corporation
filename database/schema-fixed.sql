-- MFM Corporation Database Schema - Supabase Compatible
-- CEO Remy Command Center - 19 Teams & 5 C-Level Executives

-- Enable Row Level Security
-- Note: Supabase doesn't support ALTER DATABASE SET statement_timeout
-- All timeout settings are handled automatically by Supabase
