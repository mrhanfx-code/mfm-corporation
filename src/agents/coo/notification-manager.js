...
export class NotificationManager extends AgentBase {
  constructor() {
    super({
      ...
      tools: ['send-email', 'slack-notify', 'sms-alert'],
...
- ⚠️ WARNING: Agent quality score drop, task failure × 3, budget threshold → Slack + Email
- ℹ️ INFO: Task completed, report ready, meeting reminder → Email or Slack
